...
<html id="parents">
    ...
    <body>
        ...
        <section class="Options-Panel">
            ...
            <div class = "row">
                <div class = "column" onclick="location.href = 'PcUser.jsp'">
                    <h3>PC</h3>
                ...
                <div class = "column" onclick="location.href = 'LaptopUser.jsp'">
                    <h3>Laptops</h3>
                ...
                <div class = "column" onclick="location.href = 'PeripheralsUser.jsp'">
                    <h3>Peripherals</h3>
            ...
            <div class = "row">
                <div class = "column2" onclick="location.href = 'GamesUser.jsp'">
                ...
                <div class = "column2" onclick="location.href = 'SpecialUser.jsp'">
