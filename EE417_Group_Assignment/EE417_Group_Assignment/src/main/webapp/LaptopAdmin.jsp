...
<html id="parents">
    <head id="parent"> <!--The header of the file--->
        ...
        <link rel = "stylesheet" href="Stylesheets/laptop_styles.css">
    ...
    <body>
        ...
        <section class = 'header_laptop'>
            <div class = "introduction">
                <h1>Laptop Shop</h1>
                <p>Welcome to the Laptop Shop. Here you will find laptops which can be used for school work or high performance gaming.
      ...
      SELECT itemtype, itemname, price, itemsummary, dateadded FROM testdb.computerworld_shopitems where itemtype = 'Laptop';    </sql:query>
