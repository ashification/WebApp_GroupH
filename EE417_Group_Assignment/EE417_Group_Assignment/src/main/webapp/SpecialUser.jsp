...
<html id="parents">
    ...
    <body>
      ...
      SELECT itemtype, itemname, price, itemsummary, specialprice, specialexpiry FROM testdb.computerworld_shopitems Where itemspecial = 1;    </sql:query>
