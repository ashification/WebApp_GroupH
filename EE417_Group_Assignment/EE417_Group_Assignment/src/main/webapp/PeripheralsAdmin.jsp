...
<html id="parents">
    <head id="parent"> <!--The header of the file--->
        ...
        <link rel = "stylesheet" href="Stylesheets/peripherals_styles.css">
    ...
    <body>
        ...
        <section class = 'header_peripherals'>
            <div class = "introduction">
                <h1>Peripherals Shop</h1>
                <p>Welcome to the Peripherals Shop. Here you will find numerous peripherals which can be combined with your setup.
        ...
        <section class = 'header'>
            <div class = "introduction">
                <h1>List of Peripherals on Sale</h1>
      ...
      SELECT itemtype, itemname, price, itemsummary, dateadded FROM testdb.computerworld_shopitems where itemtype = 'Peripheral';    </sql:query>
